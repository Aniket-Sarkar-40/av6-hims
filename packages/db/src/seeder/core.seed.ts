...
export async function runSeed() {
  ...
  const dynamicShortCodes: DynamicShortCodeSeeder[] = [
    ...
    {
      shortCode: "EVENT_CONFIG_KEY",
      tableName: "eventConfigKey",
      isDTO: false,
      isCacheable: false,
      permission: "core:event-config-key:view",
      isDropDown: true,
      isSingleDto: true,
      whereClause: JSON.stringify({ isActive: true }),
      selectClause: JSON.stringify({
    ...
    {
      shortCode: "EVENT_RECIPIENT_RULE",
      tableName: "eventRecipientRule",
      isDTO: true,
      isCacheable: false,
      permission: "core:event-recipient-rule:view",
      isDropDown: true,
      isSingleDto: false,
      whereClause: JSON.stringify({ isActive: true }),
      selectClause: JSON.stringify({
