...
export type CronDetailsCtx = Pick<CronDetails, "id" | "cronName" | "runDate" | "startedAt"> & {
    runKey: CronRunKey;
    attempt: number;
};
export type CronDetailsSkipReason = "ALREADY_IN_PROGRESS" | "ALREADY_SUCCESS_FOR_RUNKEY" | "RETRY_EXHAUSTED";
...
//# sourceMappingURL=cronDetails.d.ts.map