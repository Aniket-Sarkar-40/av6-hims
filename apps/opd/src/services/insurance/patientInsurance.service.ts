import { externalService } from "@/client/service/external.service.js";
...
import { InsuranceType } from "@repo/db/generated/prisma/client";
...
export const patientsInsuranceService = {
  async createPatientsInsurance(
    ...
    await externalService.uploadInsuranceImagesExt(fileInfos);
