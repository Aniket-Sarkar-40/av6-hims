import { toLastApproverDetailsDto } from "@repo/shared/mapper/approval.mapper.js";
import {
  CommonApproveReq,
  CommonGetApprovalActionReq,
  GetMyApprovalFlow,
  StartFlowReq,
} from "@repo/shared/types/approval.type.js";
import { approvalService } from "@repo/shared/service/approval.service.js";
...
export const getStaffPendingApproval = TryCatch(
  async (req: Request, res: Response) => {
    ...
    const pendingApprovalInst =
      await commonService.getStaffPendingApproval(input);
