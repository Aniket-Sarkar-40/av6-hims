...
//   await commonService.approve(input);
...
// export const getApprovalActDetails = TryCatch(async (req: Request, res: Response) => {
//   logger.info("entering::purchaseApproval::controller");
//   const input = req.body as CommonGetApprovalActionReq;

//   validIdCheck(input.id);

//   const actRecords = await approvalService.getApprovalActDetailsBySubjectId(input.id, input.subjectType, input.service);
...
//TODO: Uncomment this when approval is implemented

// export const getStaffPendingApproval = TryCatch(async (req: Request, res: Response) => {
...
//   const pendingApprovalInst = await commonService.getStaffPendingApproval(input);
...
// export const startApprovalFlow = TryCatch(async (req: Request, res: Response) => {
//   logger.info("entering::startApprovalFlow::controller");
//   const input = req.body as StartFlowReq;

//   await commonService.startFlow(input);
...
// export const getImage = TryCatch(async (req: Request, res: Response): Promise<void> => {
//   const fileName = req.params.fileName;
//   const directoryPath = req.query.path as string;

//   const fullFilePath = `${directoryPath}/${fileName}`;
//   const response = await commonService.fetchImageStream(fullFilePath);
