...
export const createCountryCode = TryCatch(
  async (req: Request, res: Response) => {
    ...
    const response = new BaseResponse(
      {
        success: true,
        message: generateSuccessMessage("CREATED", "Country Code"),
      },
      result,
    );
...
export const updateCountryCode = TryCatch(
  async (req: Request, res: Response) => {
    ...
    const response = new BaseResponse(
      {
        success: true,
        message: generateSuccessMessage("UPDATED", "Country Code"),
      },
      result,
    );
...
export const getAllCountryCode = TryCatch(
  async (req: Request, res: Response) => {
    ...
    const response = new BaseResponse(
      {
        success: true,
        message: generateSuccessMessage("FETCHED", "Country Code"),
      },
      result,
    );
...
export const deleteCountryCodeById = TryCatch(
  async (req: Request, res: Response) => {
    ...
    const response = new BaseResponse(
      {
        success: true,
        message: generateSuccessMessage("DELETED", "Country Code"),
      },
      result,
    );
