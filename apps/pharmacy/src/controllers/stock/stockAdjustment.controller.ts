...
export const updateBatchExpiry = TryCatch(
  async (req: Request, res: Response) => {
    logger.info("entering::updateBatchExpiry::controller");
    const input = req.body as updateBatchExpiryInput;
    await stockAdjustmentService.updateBatchExpiry(input);

    logger.info("exiting::updateBatchExpiry::controller");
