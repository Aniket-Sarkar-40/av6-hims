import {
  ...
  getPatientsById,
  updatePatients,
} from "@/controllers/insurance/patients.controller.js";
import {
  authorize,
  verifyToken,
...
} from "@/validations/request/insurance/patients.validation.js";
...
patientsRouter.post(
  ...
  authorize(getPermission("PMS", "PATIENT", "CREATE")),
...
patientsRouter.put(
  ...
  verifyToken(ServiceCode.PHARMACY),
  authorize(
    getPermission("PMS", "PATIENT", "VIEW"),
    getPermission("PMS", "PATIENT", "UPDATE")
  ),
  createUploadFieldsMiddleware("patient_images/patient_captured_images", [
    "image",
    "patientImage",
...
patientsRouter.get(
  "/",
  verifyToken(ServiceCode.PHARMACY),
  authorize(getPermission("PMS", "PATIENT", "VIEW")),
  getAllPatients
);
...
patientsRouter.delete(
  "/id",
  verifyToken(ServiceCode.PHARMACY),
  authorize(getPermission("PMS", "PATIENT", "DELETE")),
  deletePatients
);
...
//  *         application/json:
//  *           schema:
//  *             $ref: '#/components/patientsSearchSchema'
//  */
// patientsRouter.post(
//   "/search",
//   verifyToken,
//   authorize("pms:patients-search:add"),
//   validatepatientsSearch,
//   patientsSearch
// );

// /**
//  * @swagger
//  * /api/v1/patients/stock:
//  *   post:
//  *     summary: Search patients
//  *     tags: [Patients]
//  *     security:
...
//   "/stock",
//   verifyToken,
//   authorize("pms:patients-batch:view"),
//   validatepatientsStock,
//   getpatientsStocksBypatientsId
// );
