...
countryRouter.post(
  "/",
  verifyToken,
  authorize(getPermission("PMS", "COUNTRY", "CREATE")),
  validateCountry,
  createCountry,
);
...
countryRouter.get(
  "/",
  verifyToken,
  authorize(getPermission("PMS", "COUNTRY", "VIEW")),
  getAllCountries,
);
...
countryRouter.put(
  ...
  verifyToken,
  authorize(
    getPermission("PMS", "COUNTRY", "VIEW"),
    getPermission("PMS", "COUNTRY", "UPDATE"),
  ),
  validateCountryUpdate,
  updateCountry,
);
...
countryRouter.delete(
  "/:countryId",
  verifyToken,
  authorize(getPermission("PMS", "COUNTRY", "DELETE")),
  deleteCountry,
);
