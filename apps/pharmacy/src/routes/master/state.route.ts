...
stateRouter.post(
  "/",
  verifyToken,
  authorize(getPermission("PMS", "STATE", "CREATE")),
  validateState,
  createState,
);
...
stateRouter.get(
  "/",
  verifyToken,
  authorize(getPermission("PMS", "STATE", "VIEW")),
  getAllStates,
);
...
stateRouter.put(
  ...
  verifyToken,
  authorize(
    getPermission("PMS", "STATE", "VIEW"),
    getPermission("PMS", "STATE", "UPDATE"),
  ),
  validateStateUpdate,
  updateState,
);
...
stateRouter.delete(
  "/:stateId",
  verifyToken,
  authorize(getPermission("PMS", "STATE", "DELETE")),
  deleteState,
);
