...
export const countryCodeRouter: Router = Router();
...
countryCodeRouter.post(
  "/",
  verifyToken,
  authorize(getPermission("PMS", "COUNTRY_CODE", "CREATE")),
  validateCountryCodeCreate,
  createCountryCode,
);
...
countryCodeRouter.put(
  ...
  verifyToken,
  authorize(
    getPermission("PMS", "COUNTRY_CODE", "VIEW"),
    getPermission("PMS", "COUNTRY_CODE", "UPDATE"),
  ),
  validateCountryCodeUpdate,
  updateCountryCode,
);
...
countryCodeRouter.get(
  "/",
  verifyToken,
  authorize(getPermission("PMS", "COUNTRY_CODE", "VIEW")),
  getAllCountryCode,
);
...
countryCodeRouter.delete(
  "/",
  verifyToken,
  authorize(getPermission("PMS", "COUNTRY_CODE", "DELETE")),
  deleteCountryCodeById,
);
