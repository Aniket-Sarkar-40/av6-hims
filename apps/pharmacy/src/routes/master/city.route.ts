...
cityRouter.post(
  "/",
  verifyToken,
  authorize(getPermission("PMS", "CITY", "CREATE")),
  validateCity,
  createCity,
);
...
cityRouter.get(
  "/",
  verifyToken,
  authorize(getPermission("PMS", "CITY", "VIEW")),
  getAllCities,
);
...
cityRouter.put(
  ...
  verifyToken,
  authorize(
    getPermission("PMS", "CITY", "VIEW"),
    getPermission("PMS", "CITY", "UPDATE"),
  ),
  validateCityUpdate,
  updateCity,
);
...
cityRouter.delete(
  "/:cityId",
  verifyToken,
  authorize(getPermission("PMS", "CITY", "DELETE")),
  deleteCity,
);
