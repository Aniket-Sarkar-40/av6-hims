  ...
  return {
    ...
    Phone: employee
      ? typeof employee.phone === "string"
        ? parseInt(employee.phone, 10)
        : employee.phone
      : null,
    Email: employee ? employee.email : "",
    Notes: employee ? employee.notes : "",
    Site: employee && employee.siteId !== null ? employee.siteId : null,
    Department:
      employee && employee.departmentId !== null ? employee.departmentId : null,
    Location:
      employee && employee.locationId !== null ? employee.locationId : null,
    DOB: employee ? employee.dob : "",
    Surname: employee ? employee.surname : "",
    Designation: employee ? employee.designationId : null,
  };
};
