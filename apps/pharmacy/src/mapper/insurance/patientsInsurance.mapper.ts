import { getPatientsByUniqueIdFromDb } from "@/repository/insurance/patients.repository.js";
...
export const toPatientInsuranceDto = async (
  ...
  const patient = await getPatientsByUniqueIdFromDb(
    patientsInsurance.patientId,
  );
  ...
  return {
    ...
    createdBy: patientsInsurance.createdBy,
