...
export const createIncomeHead = TryCatch(async (req: Request, res: Response) => {
...
export const updateIncomeHead = TryCatch(async (req: Request, res: Response) => {
...
export const getIncomeHeadId = TryCatch(async (req: Request, res: Response) => {
  ...
  const allIncomeHeadsById = await incomeHeadService.getIncomeHeadById(Number(incomeHeadId));
...
export const getAllIncomeHead = TryCatch(async (req: Request, res: Response) => {
...
export const deleteIncomeHead = TryCatch(async (req: Request, res: Response) => {
