...
export const createExpenseHead = TryCatch(async (req: Request, res: Response) => {
...
export const getAllExpenseHeads = TryCatch(async (req: Request, res: Response) => {
...
export const getExpenseHeadById = TryCatch(async (req: Request, res: Response) => {
  logger.info("entering::getExpenseHeadById::controller");
  const { expenseHeadId } = req.query as { expenseHeadId: string };

  const expenseHead = await expenseHeadService.getExpenseHeadById(Number(expenseHeadId));
  if (!expenseHead) {
...
export const updateExpenseHead = TryCatch(async (req: Request, res: Response) => {
...
export const deleteExpenseHead = TryCatch(async (req: Request, res: Response) => {
  logger.info("entering::deleteExpenseHead::controller");
  const { expenseHeadId } = req.query as { expenseHeadId: string };
  const deletedExpenseHead = await expenseHeadService.deleteExpenseHead(Number(expenseHeadId));
