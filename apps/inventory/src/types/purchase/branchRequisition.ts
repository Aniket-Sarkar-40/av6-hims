...
export interface BranchRequisitionDTO extends Omit<
...
export interface BranchRequisitionDetailDTO extends Omit<
  BranchRequisitionDetails,
  "createdBy" | "updatedBy"
> {
...
export interface BranchItemDetailDTO extends Omit<
...
export interface BranchRequisitionBatchWiseDTO extends Omit<
...
export interface BrDetailDTO extends Omit<
  BranchRequisitionDetails,
